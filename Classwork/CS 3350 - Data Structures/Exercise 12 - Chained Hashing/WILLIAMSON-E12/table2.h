...
//   Table. It may be any type with a default constructor, a copy constructor,
...
namespace main_savitch_12B
{
    ...
    public:
        ...
        static const std::size_t TABLE_SIZE = 8011;
    ...
    private:
        ...
        void free (); // for use by the destructor and the operator=
        void copy (const table&); // for use by the copy constructor and the operator=
    };
}

#include "table2template.h" // Include the implementation
